...
- [`fit(`*`<infer>`*`)`](https://infer.tidymodels.org/dev/reference/fit.infer.md)
...
- [`visualize()`](https://infer.tidymodels.org/dev/reference/visualize.md)
  [`visualise()`](https://infer.tidymodels.org/dev/reference/visualize.md)
...
- [`infer-package`](https://infer.tidymodels.org/dev/reference/infer.md)
  [`infer`](https://infer.tidymodels.org/dev/reference/infer.md) :
  infer: a grammar for statistical inference
- [`gss`](https://infer.tidymodels.org/dev/reference/gss.md) : Subset of
...
- [`%>%`](https://infer.tidymodels.org/dev/reference/pipe.md) : Pipe
- [`print(`*`<infer>`*`)`](https://infer.tidymodels.org/dev/reference/print.infer.md)
  [`print(`*`<infer_layer>`*`)`](https://infer.tidymodels.org/dev/reference/print.infer.md)
  [`print(`*`<infer_dist>`*`)`](https://infer.tidymodels.org/dev/reference/print.infer.md)
  : Print methods
