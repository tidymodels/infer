...
[`specify()`](https://infer.tidymodels.org/dev/reference/specify.md). In
the context of confidence intervals, this is a bootstrap distribution
based on the result of
[`specify()`](https://infer.tidymodels.org/dev/reference/specify.md). In
the context of hypothesis testing, this is a null distribution based on
the result of
