...
The `method = "both"` examples here do another randomization instead of using the one
with `visualize()` set to the default of `method = "randomization"`. This is to show the full
...
Randomization approach to z-statistic
...
Randomization approach to $t$-statistic (Not implemented)
