...
To install the developmental version of `infer`, make sure to install `remotes` first. A website corresponding to this developmental version is at https://infer.netlify.com. 
