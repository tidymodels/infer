...
To install the developmental stable version of `infer`, make sure to install `remotes` first. The `pkgdown` website for the package is at <https://infer.tidymodels.org>.
