...
Check the package vignettes for further examples using theory-based methods
in combination with randomization-based methods. The examples below only show the calculation of randomization-based statistics. Check the vignettes for ways to `visualize()` these statistics.
