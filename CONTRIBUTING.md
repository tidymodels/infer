...
Contributions to the `infer` whether in the form of bug fixes, issue
...
conduct](https://infer.tidymodels.org/CODE_OF_CONDUCT.md) guidelines.
...
`infer` uses `testthat` for testing. Please try to provide 100% test
...
conduct defined in
[CONDUCT](https://infer.tidymodels.org/CODE_OF_CONDUCT.md).
