...
- The aliases
  [`p_value()`](https://infer.tidymodels.org/reference/deprecated.md)
  and
  [`conf_int()`](https://infer.tidymodels.org/reference/deprecated.md),
...
- Fixed bug where
  ...
  [`specify()`](https://infer.tidymodels.org/reference/specify.md)ing
...
- The `weight_by` argument to
  [`rep_slice_sample()`](https://infer.tidymodels.org/reference/rep_sample_n.md)
...
- Newly accommodates variables with spaces in names in the wrapper
  functions
  [`t_test()`](https://infer.tidymodels.org/reference/t_test.md) and
...
- Fix [`generate()`](https://infer.tidymodels.org/reference/generate.md)
  errors when columns are named `x`
  ([\#431](https://github.com/tidymodels/infer/issues/431)).
- Fix error from `visualize` when passed
  [`generate()`](https://infer.tidymodels.org/reference/generate.md)d
...
- [`specify()`](https://infer.tidymodels.org/reference/specify.md) and
  wrapper functions now appropriately handle ordered factors
...
- supply a consistent error when the supplied `stat` argument isn’t
  ...
  [`specify()`](https://infer.tidymodels.org/reference/specify.md)d
...
[`observe()`](https://infer.tidymodels.org/reference/observe.md), a
wrapper function around
[`specify()`](https://infer.tidymodels.org/reference/specify.md),
[`hypothesize()`](https://infer.tidymodels.org/reference/hypothesize.md),
and
[`calculate()`](https://infer.tidymodels.org/reference/calculate.md), to
calculate observed statistics. The function provides a shorthand
...
[`assume()`](https://infer.tidymodels.org/reference/assume.md), that
...
[`assume()`](https://infer.tidymodels.org/reference/assume.md) and
replacing arguments as needed.
...
- Fixed several bugs related to factors with unused levels.
  [`specify()`](https://infer.tidymodels.org/reference/specify.md) will
  now drop unused factor levels and message that it has done so.
...
- [`rep_sample_n()`](https://infer.tidymodels.org/reference/rep_sample_n.md)
...
- Add alias for
  [`hypothesize()`](https://infer.tidymodels.org/reference/hypothesize.md)
  ([`hypothesise()`](https://infer.tidymodels.org/reference/hypothesize.md))
...
- Fix [`t_test()`](https://infer.tidymodels.org/reference/t_test.md) and
...
- Changed method of computing two-sided p-value to a more conventional
  one. It also makes
  [`get_pvalue()`](https://infer.tidymodels.org/reference/get_p_value.md)
  and
  [`visualize()`](https://infer.tidymodels.org/reference/visualize.md)
  more aligned
...
- [`shade_p_value()`](https://infer.tidymodels.org/reference/shade_p_value.md) -
  ...
  [`visualize()`](https://infer.tidymodels.org/reference/visualize.md)
  output. Has alias
  [`shade_pvalue()`](https://infer.tidymodels.org/reference/shade_p_value.md).
- [`shade_confidence_interval()`](https://infer.tidymodels.org/reference/shade_confidence_interval.md) -
  {ggplot2}-like layer function to add information about confidence
  interval region to
  [`visualize()`](https://infer.tidymodels.org/reference/visualize.md)
  output. Has alias
  [`shade_ci()`](https://infer.tidymodels.org/reference/shade_confidence_interval.md).
...
- Account for `NULL` value in left hand side of formula in
  ...
  in [`generate()`](https://infer.tidymodels.org/reference/generate.md)
...
- Fixed [`t_stat()`](https://infer.tidymodels.org/reference/t_stat.md)
  to use `...` so `var.equal` works
...
- Implemented
  ...
  - [`get_ci()`](https://infer.tidymodels.org/reference/get_confidence_interval.md)
    and
    [`get_confidence_interval()`](https://infer.tidymodels.org/reference/get_confidence_interval.md)
    are aliases for
    [`conf_int()`](https://infer.tidymodels.org/reference/deprecated.md)
...
- Tweaked
  [`chisq_stat()`](https://infer.tidymodels.org/reference/chisq_stat.md)
  and [`t_stat()`](https://infer.tidymodels.org/reference/t_stat.md) to
  match with `specify() %>% calculate()` framework
  - Both work in the one sample and two sample cases by providing
    `formula`
  - Added `order` argument to
    [`t_stat()`](https://infer.tidymodels.org/reference/t_stat.md)
- Added implementation of one sample
  [`t_test()`](https://infer.tidymodels.org/reference/t_test.md) by
