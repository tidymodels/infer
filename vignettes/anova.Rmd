...
To visualize both the simulation-based and theoretical null distributions to get a sense of how the two relate, we can pipe the simulation-based null distribution into `visualize()`, and then further provide `method = "both"` to `visualize()`.
