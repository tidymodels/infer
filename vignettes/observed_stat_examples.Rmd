...
Instead of a simulation-based null distribution, we can also define a theory-based sampling distribution,
...
Visualization and calculation of confidence intervals interfaces in the same way as with the simulation-based null distribution,
...
See the above subsection (one mean) for a theory-based approach.
