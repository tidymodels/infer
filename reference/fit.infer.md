...
[`generate()`](https://infer.tidymodels.org/reference/generate.md), it
will fit a model to each data resample, denoted in the `replicate`
...
- object:
  ...
  [`generate()`](https://infer.tidymodels.org/reference/generate.md) or
  [`specify()`](https://infer.tidymodels.org/reference/specify.md)—which
...
- `replicate`: Only supplied if the input object had been previously
  passed to
  [`generate()`](https://infer.tidymodels.org/reference/generate.md). A
  number corresponding to which resample of the original data set the
  model was fitted to.
...
[`generate()`](https://infer.tidymodels.org/reference/generate.md). By
default, all of the explanatory variables are treated as fixed.) A
